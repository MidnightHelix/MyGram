...
func CompareHashAndPassword(existingPassword string, reqPassword string) (err error) {
	err = bcrypt.CompareHashAndPassword([]byte(existingPassword), []byte(reqPassword))
	if err != nil {
